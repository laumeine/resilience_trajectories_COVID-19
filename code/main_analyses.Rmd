...
data_long <- read.csv("../anonymized_data/data_matched_long.csv", header=T, sep="\t") # data T0-T3, long format
data_wide <- read.csv("../anonymized_data/data_matched_wide.csv", header=T, sep="\t") # data T0-T3, wide format
data_pandemic <- read.csv("../anonymized_data/data_matched_pandemic.csv", header=T, sep="\t") # data pandemic
...
#write.table(classes, "../anonymized_data/RF_trajectory_classes.csv", sep="\t", col.names = T, row.names = F)
